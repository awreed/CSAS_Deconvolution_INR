...
def get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=3,
    ...
    num_scales=5, downsample_mode='stride', need_sigmoid=False, need_bias=True):
    if NET_TYPE == 'ResNet':
        # TODO
        ...
        net = skip(input_depth, n_channels, num_channels_down = [skip_n33d]*num_scales if isinstance(skip_n33d, int) else skip_n33d,
                                            ...
                                            need_bias=need_bias, pad=pad, act_fun=act_fun)
        ...
        net = UNet(num_input_channels=input_depth, num_output_channels=3, 
                   ...
                   norm_layer=nn.BatchNorm2d, need_sigmoid=need_sigmoid,
                   need_bias=need_bias)
